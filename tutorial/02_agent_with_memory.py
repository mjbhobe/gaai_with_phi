"""
agent_with_memory.py - adding memory to our Q&A agent, so that it can remember
  previous "questions & responses" (we'll limit to prev 5 responses)

This application adds basic "chatting" capabilities to our Q&A agent. The chatting
capability comes from the Agent's ability to remember the conversation thread like 
we humans do (we are limiting the Agent to previous 5 "conversations" here). Adding
this ability helps you to build more engaging and context-aware applications.
